    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Track time, manage billable hours, and analyze productivity
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="card-hover">
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 mt-2">
              <StatusBadge 
                status={billableAmount > 0 ? 'active' : 'pending'} 
                showDot 
              />
              <span className="text-xs text-muted-foreground">
                {((billableAmount / totalAmount) * 100).toFixed(0)}% billable
              </span>
            </div>
          </CardContent>
        </Card>
        <Card className="card-hover">
          ...
          <CardContent>
            <div className="text-2xl font-bold">€{billableAmount.toFixed(2)}</div>
            <p className="text-xs text-muted-foreground">Billable to clients</p>
          </CardContent>
        </Card>
        <Card className="card-hover">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {timer.isRunning ? formatTime(timer.elapsedTime) : '0:00:00'}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="card-hover">
          <CardHeader>
            ...
            <CardDescription>
              Daily time tracking over the last 30 days
            </CardDescription>
          </CardHeader>
          <CardContent>
            <CustomLineChart 
              data={[
                { name: 'Week 1', hours: 32, billable: 28 },
                { name: 'Week 2', hours: 28, billable: 25 },
                { name: 'Week 3', hours: 35, billable: 30 },
                { name: 'Week 4', hours: 30, billable: 27 },
              ]} 
              config={{
        ...
        <Card className="card-hover">
          <CardHeader>
            ...
            <CardDescription>
              Billable hours and revenue breakdown
            </CardDescription>
          </CardHeader>
          <CardContent>
            <CustomBarChart 
              data={[
                { name: 'Case A', hours: 24, revenue: 2400 },
                { name: 'Case B', hours: 18, revenue: 1800 },
                { name: 'Case C', hours: 32, revenue: 3200 },
                { name: 'Case D', hours: 12, revenue: 1200 },
              ]} 
              config={{
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="timer-description">Work Description</Label>
                <Input
